...
public class HMTransform3 extends Transform3
{
    ...
    public HMTransform3(Matrix4x4 m, Matrix4x4 i)
    {
        M = new Matrix4x4(m);
        I = new Matrix4x4(i);
    }

    public HMTransform3 multiply(HMTransform3 t)
    {
    ...
    public static HMTransform3 createIdentity()
    {
    ...
    public static HMTransform3 createTranslator(float x, float y, float z)
    {
        HMTransform3 r = new HMTransform3();
    ...
    public static HMTransform3 createScaler(float x, float y, float z)
    {
        HMTransform3 r = new HMTransform3();
        r.setAsScaler(x, y, z);
        return r;
    ...
    public static HMTransform3 createRotator(float xy, float xz, float yz)
    {
        HMTransform3 r = new HMTransform3();
